...
- 使用 [../templates/analysis-report.md](../templates/analysis-report.md) <!-- pathref: joinquant_skill/templates/analysis-report.md --> 作为骨架。
...
- 使用 [../templates/performance-report.md](../templates/performance-report.md) <!-- pathref: joinquant_skill/templates/performance-report.md --> 作为骨架。
