...
- [templates/analysis-report.md](templates/analysis-report.md) <!-- pathref: agents_joinquant_skill/templates/analysis-report.md -->：策略分析报告模板
- [templates/performance-report.md](templates/performance-report.md) <!-- pathref: agents_joinquant_skill/templates/performance-report.md -->：性能分析报告模板
