...
description: 创建、修改、验证仓库级 Skill、.agents/skills 单一来源、Symlink 分发、ownership 索引和 Skill 发现治理时使用。
---
...
- Codex 直接读取 `.agents/skills/`；Claude Code 通过 `.claude/skills` Symlink 读取同一份内容。
