...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `research.docs_index` | research-platform | active | `scripts.research` | `cli` | `scripts.research.docs` | `.\.venv\Scripts\python.exe -m scripts.research.docs` | `scripts/research/platform/README.md` | `scripts/research/platform/tests/test_platform.py` | `Markdown reports`<br>`pathref comments` | `docs/indexes/docs_catalog.json`<br>`docs/indexes/reports_catalog.json`<br>`docs/indexes/datasets_catalog.json`<br>`docs/indexes/variants_catalog.json` |
