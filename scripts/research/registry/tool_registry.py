...
TOOL_DEFINITIONS: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        ...
        description="Local PR preparation, draft PR synchronization, Codex review trigger, diagnostics, required-check waiting, merge and cleanup.",
        readme_path="scripts/research/governance/README.md",
