...
git switch main
.\.venv\Scripts\python.exe -m scripts.research.governance.branch_protection authorize-main --action ref-sync --reason "sync origin/main after PR #<n> merge" -- git merge --ff-only origin/main
git branch -d <branch>
```
