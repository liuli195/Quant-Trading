"""Filesystem layout helpers for ETF window research projects."""
...
DEFAULT_RAW_BUNDLE_NAME = "etf_window_research_prices.json"
DEFAULT_EXPORT_SCRIPT_NAME = "jq_research_export.py"
...
class ResearchProjectLayout:
    ...
    @property
    def joinquant_exports_dir(self) -> Path:
        return self.root / "exports" / "joinquant"

    @property
    def runs_dir(self) -> Path:
        return self.root / "runs"

    def raw_price_bundle_path(self, filename: str = DEFAULT_RAW_BUNDLE_NAME) -> Path:
        return self.raw_inputs_dir / filename

    def joinquant_export_script_path(self, filename: str = DEFAULT_EXPORT_SCRIPT_NAME) -> Path:
        return self.joinquant_exports_dir / filename
...
class ResearchRunLayout:
    """Directory layout for one analysis run."""
