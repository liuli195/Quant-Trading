...
- 研究流程说明：[research-workflow.md](docs/research-workflow.md) <!-- pathref: docs/research-workflow.md -->
- 旧项目迁移说明：[research-workflow-migration.md](docs/research-workflow-migration.md) <!-- pathref: docs/research-workflow-migration.md -->
- 仓库总规则：[CLAUDE.md](CLAUDE.md) <!-- pathref: repo/CLAUDE.md -->
...
- `CLAUDE.md` 包含当前正式入口。
- `docs/research-workflow.md` 包含当前标准流程。
...
- `docs/research-workflow-migration.md`
- `CLAUDE.md`
