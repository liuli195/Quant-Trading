...
- 根目录不再保留重复文档索引；规则索引归 [docs/rules/index.md](../../../../docs/rules/index.md) <!-- pathref: docs/rules/index.md -->，ADR 入口归 [docs/adr/index.md](index.md) 。
...
- 仓库级规则正文继续放在 [docs/rules](../../../../docs/rules) <!-- pathref: docs/rules -->。
- 命令和本地环境规则独立为 [commands.md](../../../../docs/rules/commands.md) <!-- pathref: docs/rules/commands.md -->。
...
- 合并重复 Python 环境规则到 [commands.md](../../../../docs/rules/commands.md) <!-- pathref: docs/rules/commands.md -->，根入口不重复命令细节。
- 将 Python 环境规则收敛为默认必须提权使用项目 `.venv`，不改用系统 Python。
- 删除“CLAUDE.md 包含全部目录结构、工具入口、代码规范、提交清单”的根文件承诺，改由 [docs/rules/index.md](../../../../docs/rules/index.md) <!-- pathref: docs/rules/index.md --> 分组披露。
