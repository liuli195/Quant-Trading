...
- [CLAUDE.md](../../AGENTS.md) <!-- pathref: repo/AGENTS.md --> 是 AI 助手的统一入口。此入口模型已由 [ADR 0005](0005-ai-entry-progressive-disclosure.md) <!-- pathref: docs/adr/0005-ai-entry-progressive-disclosure.md --> 更新为 [AGENTS.md](../../AGENTS.md) <!-- pathref: repo/AGENTS.md --> 通用入口。
