...
- 顶层 [AGENTS.md](../../AGENTS.md) <!-- pathref: repo/AGENTS.md --> 只保留 `Review guidelines` 指向，完整规则维护在 [review-guidelines.md](../rules/review-guidelines.md) <!-- pathref: docs/rules/review-guidelines.md -->。此条已由 [ADR 0005](0005-ai-entry-progressive-disclosure.md) <!-- pathref: docs/adr/0005-ai-entry-progressive-disclosure.md --> 更新为 `AGENTS.md` 作为通用入口，[indexes.md](../../indexes.md) <!-- pathref: repo/indexes.md --> 作为根文档索引。
- [CLAUDE.md](../../CLAUDE.md) <!-- pathref: repo/CLAUDE.md --> 仍是 AI 助手主入口和权威规则源。此条已由 [ADR 0005](0005-ai-entry-progressive-disclosure.md) <!-- pathref: docs/adr/0005-ai-entry-progressive-disclosure.md --> 更新为 `CLAUDE.md` 只保留 Claude Code 专属指针。
