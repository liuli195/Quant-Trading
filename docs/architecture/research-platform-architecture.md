...
审计覆盖工具登记、README/文档/测试锚点、CLI help、workflow template schema、`AGENTS.md`、`CLAUDE.md`、.agents/skills 单一来源与 .claude/skills Junction、数据 catalog、报告 catalog 和 pathref。`gate` 是本地 hook 和 CI 使用的门禁入口，会同时运行治理审计和 pathref 校验。
